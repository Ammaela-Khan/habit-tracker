  ...
  function render(){
    ...
    state.habits.forEach(h => {
      ...
      weekKeys.forEach(k => {
        ...
        btn.setAttribute(
          "style",
          "display:flex;align-items:center;justify-content:center;width:36px;height:36px;margin:auto;border-radius:8px;border:1px solid #f7c9e0;cursor:pointer;user-select:none;background:"+(checked?"#e9f8ef":"#fff")+";color:"+(checked?"#1e9e4a":"inherit")+";font-weight:"+(checked?"700":"400")+";"
        );
      ...
      const streakCol = document.createElement("div");
      streakCol.setAttribute("style","padding:30px;font-variant-numeric:tabular-nums;");
      ...
      tick.setAttribute("style","background:#fff;border:1px solid #f7c9e0;color:#f6aad0;padding:6px 10px;border-radius:8px;cursor:pointer;");
